...
% draw axis
P.facealpha = 1;
hx = ut_arrow3(h,[0 0 0],[axlength 0 0],8,[1 0.5 0.5],30,15,[1 0.5 0.5],1,P);
hy = ut_arrow3(h,[0 0 0],[0 axlength 0],8,[1 0.5 0.5],30,15,[1 0.5 0.5],1,P);
hz = ut_arrow3(h,[0 0 0],[0 0 axlength],8,[1 0.5 0.5],30,15,[1 0.5 0.5],1,P);
